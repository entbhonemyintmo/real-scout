...
const FeatureCard = () => {
    return (
        <TouchableOpacity className="flex flex-col items-start w-60 h-80 relative shadow-md shadow-black-100/70">
            {/* Image Background */}
...
const Card = () => {
    return (
        <TouchableOpacity className="basis-[48%] mb-4 flex p-3 rounded-2xl bg-white shadow-md shadow-black-100/70 relative">
