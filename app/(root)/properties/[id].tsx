        ...
        <View>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="pb-32 bg-white">
                ...
                <View className="mt-7 flex gap-2">
                    <Text className="px-5 text-2xl font-rubik-extrabold">{property?.name}</Text>

                    <View className=" px-5 flex flex-row items-center gap-3">
                    ...
                    <View className="px-5 flex flex-row items-center mt-5">
                    ...
                    <View className="px-5 w-full border-t border-primary-200 pt-7 mt-5">
